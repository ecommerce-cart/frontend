...
export const getAddressesBrwoser = async (): Promise<Array<Address>> => {
  const addresses = getAndParseStorageItem<ShippingAddressLocalStorage[]>('addresses') || []
...
export const useAddresses = () => {
  ...
  const setters = useCallback((addresses: Array<Address>) => {
...
export const createAddressBrowser = async (values: ShippingAddressFormData) => {
  let addresses = getAndParseStorageItem<Array<ShippingAddressLocalStorage>>('addresses') || []
...
export const createAddressAction = async (values: Partial<ShippingAddressFormData>) => {
